<?php
  ...
  while($transacao = fgetcsv ($arquivoAberto)){
    ...
    [$data,$descricao,$valor,$tipo,$categoria] = $transacao;
    $valor = str_replace("R$ ","",$valor);
    

    $transacaoAssoc = compact("data","descricao","valor","tipo","categoria");


    array_push($transacoes,$transacaoAssoc);
  }
                ...
                <tbody>
                    <?php
                      foreach($transacoes as $transacao){
                        ...
                        #Transforma os indices associativos em variaveis
                        extract($transacao);
                    ?>
                    <tr>
                        <td><?=$data?></td>
                        ...
                        <td><?=$categoria?></td>
                        <td class="despesa"> <i class="ri-arrow-down-circle-fill"></i> </td>
